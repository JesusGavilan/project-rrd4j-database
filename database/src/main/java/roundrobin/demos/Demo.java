...
public class Demo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FetchRequest request = rrdDb.createFetchRequest(AVERAGE, start, end, 3000);
        request.setFilter("shade");
        ...
        println("== Data fetched timestamps" + fetchData.getTimestamps()[0]);
        println("== Data fetched values" +  fetchData.getValues("shade")[0]);
